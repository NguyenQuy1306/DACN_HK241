...
public class SessionAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final List<String> PUBLIC_URLS = Arrays.asList("/api/v1/auth/authenticate", "/api/v1/auth/register",
            ...
            "/swagger-ui/.*", "/webjars/.*", "/api/food", "/api/combo", "/api/table/restaurant", "/api/register-restaurant",
            "/elas/createOrUpdateDocument", "/elas/searchDocument", "/elas/.*", "/elas/searchByKeyword", "/api/overbooking/*",
            ...
            "/api/payments/getOrderById", "/api/payments/deposit", "/api/payments", "/ws/*", "/ws/**", "/api/orders/customer/*/history",
            ...
            "/api/food/restaurants/*/categories/*", "/oauth2/authorization/infor", "/callbackOauthen2", "/api/food/**",
