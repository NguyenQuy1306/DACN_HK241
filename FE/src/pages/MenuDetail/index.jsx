...
function MenuDetail() {
  ...
  useEffect(() => {
    const handleGetFoodImage = async () => {
      const result = await getFoodImage([
        { foodId: id, restaurantId: restaurantOwner.maSoNhaHang },
      ]);
  ...
  useEffect(() => {
    dispatch(
      getFoodById({ restaurantId: restaurantOwner?.maSoNhaHang, foodId: id })
    );
  }, []);
  ...
  return (
    <div className={styles.container}>
        ...
        >
          ...
          <Row gutter={[64]}>
            <Col span={12}>
              ...
              >
                <InputNumber addonAfter="đ" defaultValue={0} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Upload
                  action={`${BACKEND_URL}/api/food/restaurants/${restaurantOwner.maSoNhaHang}/categories/${foodRender.danhMuc?.maSoDanhMuc}/foods/${id}/image`}
                  ...
                  onRemove={(file) =>
                    handleDeleteImage({
                      ...
                      url: file.url.replace(
                        "https:/themealbucket1.s3.amazonaws.com/",
                        ""
                      ),
                    })
                  }
          ...
          <Col span={12}>
            ...
            >
              <TextArea placeholder="Description of the dish" allowClear />
            </Form.Item>
          </Col>
          <Form.Item>
            <Button
      ...
      <div className={styles.statistics}>
        <StatisticCard title="Tổng số món ăn" quantity={45} img={foodLogo} />
        <StatisticCard
