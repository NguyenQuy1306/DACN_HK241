...
import { getRestaurantByOwnerId } from "../../redux/features/restaurantSlice";
// import ImageGallery from "./ImageGallery";

function OwnerInfoForm({ ownerId = 51 }) {
  const dispatch = useDispatch();
  const restaurantInfor = useSelector(
    (state) => state.restaurant.restaurantOwnerByAdmin
  );
  console.log("restaurantInfor", restaurantInfor);
  useEffect(() => {
    if (ownerId) {
      dispatch(getRestaurantByOwnerId({ ownerId: ownerId }));
    }
  }, [dispatch]);
  return (
      ...
      <form>
        <div className={styles.formGroup}>
          ...
          <input
            ...
            value={restaurantInfor ? restaurantInfor.ten : ""}
        ...
        <div className={styles.formGroup}>
          ...
          <input
            ...
            value={restaurantInfor ? restaurantInfor.diaChi : ""}
            className={styles.input}
          />
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <textarea
            ...
            value={restaurantInfor ? restaurantInfor.diemDacTrung : ""}
          ></textarea>
        </div>
