...
import { updateRestaurantInfor } from "../../redux/features/restaurantSlice";
...
const RestaurantInfoForm = () => {
    ...
    useEffect(() => {
        if (restaurantOwner) {
            setExistingImages(restaurantOwner.imageUrls ? restaurantOwner.imageUrls.RESTAURANTIMAGE : []);
        }
    }, [restaurantOwner]);
            ...
            existingImages.forEach((image) => {
                if (image.file) {
                    ...
                    try {
                        ...
                        if (urlObj.hostname === "themealbucket1.s3.ap-southeast-1.amazonaws.com") {
                ...
                <div className={styles.inputGrid}>
                    {restaurantOwner &&
                        Object.entries(restaurantOwner).map(([key, value]) =>
                            ["ten", "diaChi", "loaiHinh", "khoangGia", "gioHoatDong"].includes(key) ? (
                                <div
                                    key={key}
