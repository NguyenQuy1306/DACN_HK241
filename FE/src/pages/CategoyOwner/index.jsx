import { Breadcrumb, Button, Form, Input, message, Modal, Pagination, Popconfirm, Result, Upload } from "antd";
...
function CategoryOwner() {
    ...
    const editClick = (categoryId) => {
        setCurrentCategory(categoryList.category?.find((category) => category.maSoDanhMuc === categoryId));
        showModal();
    };
        ...
        <div className={styles.container}>
            ...
            <div className={styles.body}>
                ...
                >
                    ...
                    <Button
                        type="primary"
                        onClick={() => dispatch(createCategory({ restaurantId: restaurantOwner.maSoNhaHang }))}
                    >
                ...
                <div className={styles["category-wrap"]}>
                    ...
                    >
                        <Form
                            ...
                            form={form}
                            enterButton
                            onFinish={(formData) => handleUpdateCategory(currentCategory?.maSoDanhMuc, formData)}
                        >
                            <Form.Item
                                required
                                name="name"
