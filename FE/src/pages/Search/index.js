...
import "./Search.css";
import { getRestaurantsInMaps, saveCurrentPage } from "../../redux/features/restaurantSlice";
const Search = () => {
    const dispatch = useDispatch();
    const data_restaurantsImagesType = useSelector((state) => state.restaurant.restaurantsImages);
                ...
                <div className="listRestaurantDiv_H1">
                    <div className="listRestaurantDiv_H1_left">
                                                            ...
                                                            <div>
                                                                <div>
                                                                    <SortDetail
                                                                        ...
                                                                        setChooseNewRestaurant={setChooseNewRestaurant}
                        ...
                        <div className="pagination_search">
                            <Pagination count={metadata ? metadata.totalPages : 1}></Pagination>
                        </div>
                    </div>
