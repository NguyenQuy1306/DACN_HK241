...
function Home(props) {
    ...
    useEffect(() => {
        ...
        const client = new Client({
            ...
            debug: process.env.NODE_ENV === "development" ? (str) => console.log(str) : false,
        });
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            updateState({
                ...
                nextState:
                    categoryRef.current.scrollLeft + categoryRef.current.clientWidth < categoryRef.current.scrollWidth,
            });
        };
