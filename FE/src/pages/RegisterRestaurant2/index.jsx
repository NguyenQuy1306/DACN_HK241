  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post(
        `${BACKEND_URL}/api/register-restaurant`,
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <ul className={styles.progress}>
          ...
          <li
            className={[styles.separator, styles["progress-item"]].join(" ")}
          ></li>
          <li className={styles["progress-item"]}>
          ...
          <ul className={styles["reason-list"]}>
            <li className={styles["reason-item"]}>
              ...
              <p className={styles["reason-text"]}>
                Đánh giá nhu cầu và thách thức của bạn trước khi đăng ký tham
                gia TheFork
              </p>
            </li>
            <li className={styles["reason-item"]}>
              ...
              <p className={styles["reason-text"]}>
                Gợi ý cho bạn kế hoạch và công cụ phù hợp cho doanh nghiệp của
                bạn
              </p>
            </li>
            <li className={styles["reason-item"]}>
              ...
              <p className={styles["reason-text"]}>
                Hỗ trợ bạn trong quá trình gia nhập và trả lời mọi câu hỏi bạn
                có thể có
              </p>
            </li>
            <p className={styles.note}>
              Tài khoản phải được mở bởi người có thẩm quyền ký hợp đồng thay
              mặt cho doanh nghiệp của bạn. Nếu bạn không có thẩm quyền đó, vui
              lòng yêu cầu giám đốc điều hành, quản lý cấp cao hoặc giám đốc
              đăng ký thay.
            </p>
          </ul>
        </div>
