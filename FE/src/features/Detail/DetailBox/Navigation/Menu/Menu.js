...
const Menu = ({ selectedPlace }) => {
    ...
    const handleAddItem = (item, quantity) => {
        setNewCombo((prev) => {
            const existingItem = prev.find((comboItem) => comboItem.item.ten === item.ten);
            ...
            if (existingItem) {
                ...
                return prev.map((comboItem) =>
                    comboItem.item.ten === item.ten ? { ...comboItem, quantity } : comboItem,
                );
            }
                    ...
                    <div className="MenuNavBar_menu_H1">
                        ...
                        <p className="MenuNavBar_menu_H1_p">
                            <span>
                                ...
                                số có thể đặt qua The Meal, trong khi những món khác có thể tạo combo hoặc sẵn tại chỗ.
                            </span>
                        </p>
