...
import { openModalPayment, setOpenModalPayment } from "../../../../../../../../../redux/features/tableSlice";
...
const MenuChooseBookingwidget = ({
    ...
    const [choosedOptionByWithoutMenu, setChoosedOptionByWithoutMenu] = useState(false);
