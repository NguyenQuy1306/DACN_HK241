...
function RecommendCard({ place, tags, point, discountPercent }) {
  ...
  return (
    <motion.div
      ...
      onClick={() => handleOnclickToDetail(place.maSoNhaHang)}
      whileHover={{ scale: 1.05 }}
      transition={{ duration: 0.3 }}
    >
      <img
        src={
          place.imageUrls["RESTAURANTIMAGE"]
            ? place.imageUrls["RESTAURANTIMAGE"][0]
        ...
        <div className={styles["body-card-wrapper"]}>
          <div className={styles["body-card-wrapper__content"]}>
            ...
            <div className={styles.price}>
              ...
              <span
                className={styles["avg-price"]}
              >{`${place.khoangGia}đ`}</span>
            </div>
          </div>
